...
namespace ShellGrid
{
    ...
    private:
         ...
         static void printBorder(ColumnWidthMap* columnWidthMap, char* leftBorder, char* innerBorder, char* splitBorder, char* rightBorder);
         static void printCell(Cell* cell, int width);
